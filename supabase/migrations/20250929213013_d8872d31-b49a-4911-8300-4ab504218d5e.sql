-- Phase 1: Multi-tenant onboarding schema updates
...
-- (since we can't modify auth.users directly)
...
-- Update organization_invites to include invited_by and update role to support tenantAdmin
